...
const Index = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-medical-100 to-medical-200">
      ...
      <main className="container pt-24 pb-16 animate-fade-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="glass-morphism p-6 animate-fade-up" style={{
          animationDelay: "0.1s"
        }}>
          ...
          <Card className="glass-morphism p-6 md:col-span-2 animate-fade-up" style={{
          animationDelay: "0.3s"
        }}>
